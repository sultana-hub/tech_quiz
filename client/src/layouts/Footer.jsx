...
//   return (
//     <Box sx={{ bgcolor: '#1d0944ff', color: "white", py: 4, mt: 4 }}>
//       <Container maxWidth="lg">
//         <Grid container spacing={3} alignItems="center">
//           {/* Left: Contact Info */}
//           <Grid item xs={12} sm={4} textAlign={{ xs: "center", sm: "left" }}>
//             <Typography variant="h6" gutterBottom>Contact Us</Typography>
//             <Typography>Email: support@techquiz.com</Typography>
...
//           <Grid item xs={12} sm={4} textAlign="center" sx={{paddingLeft:"200px"}}>
...
//             </Box>
//             <Box mt={2}>
//               <Typography variant="body2">© {new Date().getFullYear()} TechQuiz. All rights reserved.</Typography>
//             </Box>
//           </Grid>

//           {/* Right: Quick Links */}
//           <Grid item xs={12} sm={4} textAlign={{ xs: "center", sm: "right" }} sx={{paddingLeft:"260px"}}>
          ...
          >
            ...
            <Box mt={2}>
              <Typography variant="body2">
                © {new Date().getFullYear()} TechQuiz. All rights reserved.
              </Typography>
            </Box>
          </Grid>
